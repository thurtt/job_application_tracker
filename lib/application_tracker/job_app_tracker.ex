defmodule ApplicationTracker.JobAppTracker do
  @moduledoc """
  The JobAppTracker context.
  """
  ...
  """
  def open_applications do
    from(a in Application, where: a.status == "Open") |> Repo.all()
  end

  @doc """
  Returns all closed applications
  """
  def closed_applications do
    closed_apps = from(a in Application, where: a.status != "Open") |> Repo.all()
  end
