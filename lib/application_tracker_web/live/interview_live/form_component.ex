defmodule ApplicationTrackerWeb.InterviewLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:meet_date]} type="date" label="Meet date" />
  ...
  def update(%{interview: interview} = assigns, socket) do
    changeset = JobInterviewTracker.change_interview(interview)
  ...
  def handle_event("validate", %{"interview" => interview_params}, socket) do
    changeset =
      ...
      |> JobInterviewTracker.change_interview(interview_params)
  ...
  defp save_interview(socket, :edit, interview_params) do
    case JobInterviewTracker.update_interview(socket.assigns.interview, interview_params) do
      {:ok, interview} ->
  ...
  defp save_interview(socket, :new, interview_params) do
    case JobInterviewTracker.create_interview(interview_params) do
      {:ok, interview} ->
        notify_parent({:saved, interview})
